(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["GraphQLPlugin"] = factory();
	else
		root["relm"] = root["relm"] || {}, root["relm"]["GraphQLPlugin"] = factory();
})(this, function() {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash_has__ = __webpack_require__(54);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_lodash_last__ = __webpack_require__(141);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_lodash_endsWith__ = __webpack_require__(139);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_lodash_mapValues__ = __webpack_require__(3);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_graphql_tag_parser__ = __webpack_require__(136);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_graphql_tag_parser___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6_graphql_tag_parser__);
...
var GraphQLPlugin = function () {
  function GraphQLPlugin(createQuery) {
    _classCallCheck(this, GraphQLPlugin);

    this.createQuery = createQuery;
  }

  _createClass(GraphQLPlugin, [{
    key: 'apply',
    value: function apply(component, source) {
      // Get the child fragments - saved for access from parent compoennts
      component.fragments = __WEBPACK_IMPORTED_MODULE_5_lodash_mapValues___default()(component.components, function (it) {
        return it.fragments || {};
      });
      ...
      var _source$graphql = source.graphql(tag, { components: component.fragments });

      var fragments = _source$graphql.fragments;
      var queries = _source$graphql.queries;

      // Assign any newly defined fragments so parents can use them

      __WEBPACK_IMPORTED_MODULE_4_lodash_assign___default()(component.fragments, fragments);

      var createQuery = this.createQuery;

      // Make query creators
      component.queries = __WEBPACK_IMPORTED_MODULE_5_lodash_mapValues___default()(queries, function (query, name) {
        var queryCreator = function runQuery() {
...
/* harmony default export */ exports["default"] = GraphQLPlugin;
...
function tag(literals) {
  ...
  function joinString(str, sub, i) {
    ...
    if (!__WEBPACK_IMPORTED_MODULE_3_lodash_endsWith___default()(literals[i], '...')) {
      throw new Error('All substitutions must be preceeded by a spread "..." operator');
    }

    var fragmentName = sub.name.value;
  ...
  var source = __WEBPACK_IMPORTED_MODULE_2_lodash_reduce___default()(substitutions, joinString, '') + __WEBPACK_IMPORTED_MODULE_1_lodash_last___default()(literals);
  var doc = __WEBPACK_IMPORTED_MODULE_6_graphql_tag_parser___default()(source);
  ...
  function buildQuery(queryNode) {
    ...
    traverse(queryNode.selectionSet, function collectFragments(node) {
      ...
      var nodeName = node && node.name && node.name.value;

      // Some child fragment
      if (__WEBPACK_IMPORTED_MODULE_0_lodash_has___default()(subs, nodeName)) {
        definitions.push(subs[nodeName]);
        return;
      }

      // Self defined fragment - sub the hashed name
      if (__WEBPACK_IMPORTED_MODULE_0_lodash_has___default()(fragments, nodeName)) {
...
function traverse(obj, f) {
  if (Array.isArray(obj)) obj.forEach(function (it) {
    return traverse(it, f);
  });
  var falseReturnedToStop = f(obj);
  if (falseReturnedToStop === false) return;
  if (obj.selectionSet) obj.selectionSet.selections.forEach(function (it) {
    return traverse(it, f);
  });
}
