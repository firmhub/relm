...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.unwrapImmutable = exports.makeImmutable = exports.parseComponent = exports.makeReducer = undefined;
	...
	function relm(rootComponent) {
	  ...
	  var middleware = opts.debug ? (0, _redux.applyMiddleware)(logger) : void 0;
	  var store = opts.store || (0, _redux.createStore)((0, _reducer.makeReducer)(rootComponent), middleware);

	  // Setup the component heirarchy
	  var result = (0, _component.parseComponent)(rootComponent, {
	...
	exports.makeReducer = _reducer.makeReducer;
	exports.parseComponent = _component.parseComponent;
	exports.makeImmutable = _update.makeImmutable;
	exports.unwrapImmutable = _update.unwrapImmutable;
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(global) {var checkGlobal = __webpack_require__(107);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var arrayReduce = __webpack_require__(12),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _set2 = __webpack_require__(175);

	var _set3 = _interopRequireDefault(_set2);

	var _assign2 = __webpack_require__(160);
	...
	var _clone2 = __webpack_require__(162);

	var _clone3 = _interopRequireDefault(_clone2);

	var _each2 = __webpack_require__(164);
	...
	function unwrapImmutable(result) {
	  if (result instanceof Immutable) return (0, _clone3.default)(result);
	  return result;
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.parseComponent = undefined;
	...
	var _mapValues2 = __webpack_require__(66);

	var _mapValues3 = _interopRequireDefault(_mapValues2);

	var _omit2 = __webpack_require__(173);
	  ...
	  return function getter() {
	    return _getState().map(function (state, index) {
	      ...
	      var view = parseComponent(component, {
	        ...
	        dispatch: dispatch,
	        getState: function getState() {
	          return (0, _get3.default)(_getState(), index);
	        },
	...
	function parseComponent(component, opts) {
	  ...
	  var childKeys = (0, _keys3.default)(component.components);
	  var ownActions = (0, _omit3.default)(component.actions || {}, childKeys);
	  ...
	  var actions = (0, _mapValues3.default)(ownActions, actionCreator);

	  // Prepare components
	  var components = (0, _reduce3.default)(component.components, function (obj, it, name) {
	    var childOpts = {
	      displayName: name,
	      dispatch: dispatch,
	      getState: function getState() {
	        return (0, _get3.default)(_getState2(), name);
	      },
	    ...
	    // List component
	    if ((0, _isArray3.default)(it)) {
	      return Object.defineProperty(obj, name, {
	        enumerable: true,
	        get: parseListComponent((0, _head3.default)(it), childOpts)
	      });
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _defaults2 = __webpack_require__(163);
	...
	var _has2 = __webpack_require__(166);
	...
	var _update3 = __webpack_require__(39);
	...
	function makeReducer(component) {
	  var isListComponent = (0, _isArray3.default)(component);
	  var source = isListComponent ? (0, _head3.default)(component) : component;

	  var components = (0, _mapValues3.default)(source.components, makeReducer);

	  var actions = (0, _reduce3.default)(source.actions, function convertActions(output, action, name) {
	    if (!(0, _isFunction3.default)(action)) return output;
	    output[name] = action;
	    return output;
	  }, {});

	  var init = function init() {
	    var childState = (0, _mapValues3.default)(components, function (childReducer) {
	      return childReducer();
	    });
	    if (!actions.getInitialState) return childState;

	    var clone = (0, _update3.makeImmutable)(childState);
	    var initialState = actions.getInitialState(clone);
	    return (0, _update3.unwrapImmutable)(initialState);
	  };
	...
	makeReducer.normal = function makeNormalReducer(components, actions, init) {
	  return function reducer() {
	    ...
	    var _event$type = _toArray(event.type);

	    var head = _event$type[0];

	    var tail = _event$type.slice(1);

	    var componentHasAction = (0, _has3.default)(actions, head);
	    var isChildEvent = (0, _has3.default)(components, head);

	    // Use action if defined
	    if (componentHasAction) {
	      var result = (0, _get3.default)(actions, head).apply(undefined, [(0, _update3.makeImmutable)(state)].concat(_toConsumableArray(event.args || [])));

	      // Action overrides can return undefined to let the action pass through
	      var ignoreResult = result === void 0;
	      if (!ignoreResult) return (0, _update3.unwrapImmutable)(result);
	    }

	    // Call child reducer if not already handled by local action
	    if (isChildEvent) {
	      var childReducer = components[head];
	      var _result = childReducer(state[head], (0, _defaults3.default)({ type: tail }, event));
	      return (0, _update3.update)(state, _defineProperty({}, head, { $set: _result }));
	    }
	...
	makeReducer.list = function makeListReducer(components, actions, init) {
	  return function listReducer() {
	    ...
	    var _event$type2 = _toArray(event.type);
	    ...
	    if (componentHasAction) {
	      ...
	      // Action overrides can return undefined to let the action pass through
	      var ignoreResult = result === void 0;
	      if (!ignoreResult) return (0, _update3.update)(list, { $splice: [[index, 1, (0, _update3.unwrapImmutable)(result)]] });
	    }

	    // Call child reducer if not already handled by local action
	    if (isChildEvent) {
	      var childReducer = components[head];
	      var _result2 = childReducer(list[head], (0, _defaults3.default)({ type: tail }, event));
	      return (0, _update3.update)(list, _defineProperty({}, index, _defineProperty({}, head, { $set: _result2 })));
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var indexOfNaN = __webpack_require__(133);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var apply = __webpack_require__(43),
	    ...
	    assignInWith = __webpack_require__(161),
	    rest = __webpack_require__(37);
