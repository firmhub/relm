...
var getPrototype = interopDefault(require$$2$1),
    ...
    isObjectLike = interopDefault(require$$0);
...
module.exports = interopDefault(require$$0$2)(commonjsGlobal || window || commonjsGlobal);
});
...
var _symbolObservable = interopDefault(require$$0$1);
...
var _warning = interopDefault(require$$0$3);
...
var _compose = interopDefault(require$$0$4);
...
var compose = index.compose;
var applyMiddleware = index.applyMiddleware;
var bindActionCreators = index.bindActionCreators;
var combineReducers = index.combineReducers;
