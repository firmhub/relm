(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("lodash/assign"), require("lodash/endsWith"), require("lodash/has"), require("lodash/last"), require("lodash/mapValues"), require("lodash/reduce"));
	else if(typeof define === 'function' && define.amd)
		define(["lodash/assign", "lodash/endsWith", "lodash/has", "lodash/last", "lodash/mapValues", "lodash/reduce"], factory);
	else if(typeof exports === 'object')
		exports["GraphQLPlugin"] = factory(require("lodash/assign"), require("lodash/endsWith"), require("lodash/has"), require("lodash/last"), require("lodash/mapValues"), require("lodash/reduce"));
	else
		root["GraphQLPlugin"] = factory(root["lodash/assign"], root["lodash/endsWith"], root["lodash/has"], root["lodash/last"], root["lodash/mapValues"], root["lodash/reduce"]);
})(this, function(__WEBPACK_EXTERNAL_MODULE_7__, __WEBPACK_EXTERNAL_MODULE_73__, __WEBPACK_EXTERNAL_MODULE_25__, __WEBPACK_EXTERNAL_MODULE_26__, __WEBPACK_EXTERNAL_MODULE_1__, __WEBPACK_EXTERNAL_MODULE_19__) {
...
var _reduce2 = __webpack_require__(19);

var _reduce3 = _interopRequireDefault(_reduce2);

var _endsWith2 = __webpack_require__(73);
...
var GraphQLPlugin = function () {
  ...
  _createClass(GraphQLPlugin, [{
    ...
    value: function apply(component, source) {
      ...
      component.fragments = (0, _mapValues3.default)(component.components, function (it) {
        return it.fragments || {};
      });
      ...
      (0, _assign3.default)(component.fragments, fragments);

      var createQuery = this.createQuery;

      // Make query creators
      component.queries = (0, _mapValues3.default)(queries, function (query, name) {
...
function tag(literals) {
  ...
  function joinString(str, sub, i) {
    ...
    if (!(0, _endsWith3.default)(literals[i], '...')) {
  ...
  var source = (0, _reduce3.default)(substitutions, joinString, '') + (0, _last3.default)(literals);
  var doc = (0, _parser.parse)(source);
